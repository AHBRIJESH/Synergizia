      ...
      <div className="container mx-auto px-4">
        <AnimationWrapper>
          <h2 className="text-3xl md:text-4xl font-bold mb-2 text-center">
            Event <span className="text-synergizia-purple">Schedule</span>
          </h2>
          <div className="w-20 h-1 bg-synergizia-gold mx-auto mb-6"></div>
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">
            Plan your day at SYNERGIZIA25 with our comprehensive event schedule.
            Note that some events run concurrently.
          </p>
        </AnimationWrapper>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="relative">
            {/* Timeline line */}
            <div className="absolute left-1/2 top-0 h-full w-0.5 bg-gradient-to-b from-synergizia-purple via-synergizia-blue to-synergizia-gold"></div>

            {schedule.map((item, index) => (
              <AnimationWrapper key={index} delay={index * 150}>
                <div className="relative flex items-center mb-10">
                  {/* Time (now on the left) */}
                  ...
                  <div
                    className={cn(
                      "absolute left-1/2 w-4 h-4 rounded-full -ml-2",
