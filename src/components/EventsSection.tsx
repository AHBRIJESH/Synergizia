...
import { Edit, Calendar, Search, List, User, Mail, FileText, Clock } from 'lucide-react';
...
const events: Event[] = [
  ...
  },
  {
    ...
    icon: <Calendar className="text-synergizia-blue" />
  }
];
  ...
  return (
    <section id="events" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <AnimationWrapper>
          <h2 className="text-3xl md:text-4xl font-bold mb-2 text-center">Our <span className="text-synergizia-purple">Events</span></h2>
          <div className="w-20 h-1 bg-synergizia-gold mx-auto mb-6"></div>
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">
            Participate in our exciting range of technical and non-technical events designed to challenge your skills and showcase your talents.
          </p>
        </AnimationWrapper>
        ...
        <Tabs defaultValue="all" className="mb-12">
          <TabsList className="mx-auto flex justify-center">
            ...
            <TabsTrigger value="technical" onClick={() => setFilter('technical')}>Technical</TabsTrigger>
            <TabsTrigger value="non-technical" onClick={() => setFilter('non-technical')}>Non-Technical</TabsTrigger>
          </TabsList>
